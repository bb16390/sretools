...
class Icon(AmisNode):
    ...
    vendor: Optional[str] = (
        None  # icon vendor, icon supports fontawesome v4 by default, if you want to support fontawesome v5
    )
...
class Badge(AmisNode):
    ...
    text: Union[int, str, None] = (
        None  # Corner text, supports strings and numbers, invalid when mode='dot'
    )
    size: Optional[int] = None  # Angular size
    level: Optional[str] = (
        None  # The level of the corner label, which can be info/success/warning/danger, after setting the
    )
    # background color of the corner label is different
    overflowCount: Optional[int] = None  # 99 # Set the capped number value
    position: Optional[str] = (
        None  # "top-right" # Corner position, can be top-right/top-left/bottom-right/bottom-left
    )
    offset: Optional[int] = (
        None  # The position of the corner label, the priority is greater than the position, when the
    )
    ...
    visibleOn: Optional[Expression] = (
        None  # Controls the display and hiding of corner labels
    )
...
class Page(AmisNode):
    ...
    remark: Optional[RemarkT] = (
        None  # A prompt icon will appear near the title, and the content will be prompted when the
    )
    # mouse is placed on it.
    aside: SerializeAsAny[Optional[SchemaNode]] = (
        None  # Add content to the sidebar area of the page
    )
    asideResizor: Optional[bool] = (
        None  # whether the width of the sidebar area of the page can be adjusted
    )
    asideMinWidth: Optional[int] = (
        None  # The minimum width of the sidebar area of the page
    )
    asideMaxWidth: Optional[int] = (
        None  # The maximum width of the sidebar area of the page
    )
    toolbar: SerializeAsAny[Optional[SchemaNode]] = (
        None  # Add content to the upper right corner of the page.
    )
    ...
    body: SerializeAsAny[Optional[SchemaNode]] = (
        None  # Add content to the content area of the page
    )
    ...
    mobileCSS: Optional[str] = (
        None  # Custom mobile CSS styles, please refer to used theme styles
    )
    toolbarClassName: Optional[str] = (
    ...
    asideClassName: Optional[str] = (
        None  # "w page-aside-region bg-auto" # Aside dom class name
    )
    headerClassName: Optional[str] = (
        None  # "bg-light bb wrapper" # Header area dom class name
    )
    initApi: Optional[API] = (
        None  # The api that Page uses to get initial data. The returned data can be used at the entire
    )
    # page level.
    initFetch: Optional[bool] = None  # True # whether to start pulling initApi
    initFetchOn: Optional[Expression] = (
        None  # whether to start pulling initApi, configure by expression
    )
    interval: Optional[int] = None  # refresh time (minimum 1000)
    silentPolling: Optional[bool] = (
        None  # False # whether to show the loading animation when the configuration is refreshed
    )
    stopAutoRefreshWhen: Optional[Expression] = (
...
class Flex(AmisNode):
    ...
    justify: Optional[str] = (
        None  # "start", "flex-start", "center", "end", "flex-end", "space-around", "space-between",
    )
    # "space-evenly"
    alignItems: Optional[str] = (
        None  # "stretch", "start", "flex-start", "flex-end", "end", "center", "baseline"
    )
...
class Grid(AmisNode):
    ...
    class Column(AmisNode):
        ...
        valign: Optional[str] = (
            None  # 'top'|'middle'|'bottom'|'between = None # Vertical alignment of the current column content
        )
    ...
    className: Optional[str] = None  # The class name of the outer Dom
    gap: Optional[str] = (
        None  # 'xs'|'sm'|'base'|'none'|'md'|'lg = None # Horizontal gap
    )
    valign: Optional[str] = (
        None  # 'top'|'middle'|'bottom'|'between = None # Vertical alignment
    )
    align: Optional[str] = (
        None  # 'left'|'right'|'between'|'center = None # Horizontal alignment
    )
...
class Panel(AmisNode):
    ...
    headerClassName: Optional[str] = (
        None  # "panel-heading" # The class name of the header area
    )
    footerClassName: Optional[str] = (
        None  # "panel-footer bg-light lter wrapper" # The class name of the footer area
    )
    actionsClassName: Optional[str] = (
        None  # "panel-footer" # The class name of the actions area
    )
    bodyClassName: Optional[str] = (
        None  # "panel-body" # The class name of the body area
    )
...
class Tabs(AmisNode):
    ...
    class Item(AmisNode):
        ...
        hash: Optional[str] = (
            None  # After setting, it will correspond to the hash of the url
        )
        reload: Optional[bool] = (
            None  # After setting, the content will be re-rendered every time, which is useful for
        )
        # re-pulling crud
        unmountOnExit: Optional[bool] = (
            None  # Each exit will destroy the current tab bar content
        )
        className: Optional[str] = (
            None  # "bg-white bl br bb wrapper-md" # Tab area style
        )
        iconPosition: Optional[str] = None  # "left" # Tab's icon position left / right
        closable: Optional[bool] = (
            None  # False # whether to support deletion, the priority is higher than the closable of the
        )
        # component
    ...
    className: Optional[str] = None  # The class name of the outer Dom
    mode: Optional[str] = (
        None  # Display mode, the value can be line, card, radio, vertical, chrome, simple, strong, tiled,
    )
    # sidebar
    ...
    scrollable: Optional[bool] = (
        None  # False # whether the navigation supports content overflow scrolling, this property is
    )
    # not supported in vertical and chrome modes; chrome mode defaults to compress tags (property discarded)
    tabsMode: Optional[TabsModeEnum] = (
        None  # Display mode, the value can be line, card, radio, vertical, chrome, simple,
    )
...
class Horizontal(AmisNode):
    ...
    offset: Optional[int] = (
        None  # When the label is not set, the offset of the right controller
    )
...
class Action(AmisNode):
    ...
    actionType: Optional[str] = (
        None  # [Required] This is the core configuration of the action to specify the action type of
    )
    ...
    level: Optional[LevelEnum] = (
        None  # Button style, support: link, primary, secondary, info, success, warning, danger,
    )
    # light, dark, default.
    ...
    activeLevel: Optional[str] = (
        None  # The style when the button is highlighted, the configuration supports the same level.
    )
    activeClassName: Optional[str] = (
        None  # Add a class name to the button highlight. "is-active"
    )
    block: Optional[bool] = None  # Use display:"block" to display the button.
    confirmText: Optional[Template] = (
        None  # When set, the action will ask the user before starting. Available ${xxx} values.
    )
    reload: Optional[str] = (
        None  # Specify the name of the target component that needs to be refreshed after this operation (
    )
    # the name value of the component, configured by yourself), please separate multiple ones with , signs.
    tooltip: Optional[str] = (
        None  # This text pops up when the mouse stays, and the object type can also be configured: the
    )
    # fields are title and content. Available ${xxx} values.
    disabledTip: Optional[str] = (
        None  # The text will pop up when the mouse stays after it is disabled. You can also configure
    )
    # the object type: the fields are title and content. Available ${xxx} values.
    tooltipPlacement: Optional[str] = (
        None  # If tooltip or disabledTip is configured, specify the location of the prompt
    )
    ...
    onClick: Optional[str] = (
        None  # The custom click event defines the click event through onClick in the form of a string,
    )
    ...
    script: Optional[str] = (
        None  # Customize JS script code, any action can be performed by calling doAction in the code,
    )
...
class ActionType:
    ...
    class Ajax(Action):
        ...
        redirect: Optional[Template] = (
            None  # Specify the path to redirect to after the current request ends, which can be
        )
        # valued by ${xxx}.
        feedback: SerializeAsAny[Optional["Dialog"]] = (
        ...
        messages: Optional[dict] = (
            None  # success: a message will be displayed after the ajax operation is successful. It can
        )
    ...
    class Dialog(Action):
        ...
        nextCondition: Optional[bool] = (
            None  # Can be used to set the condition of the next data, the default is true.
        )
    ...
    class Copy(Action):
        ...
        copyFormat: Optional[str] = (
            None  # You can set the copy format through copyFormat, the default is text text/html
        )
    ...
    class Toast(Action):
        ...
        class ToastItem(AmisNode):
            ...
            level: Optional[str] = (
                None  # default 'info', Display icon, optional 'info', 'success', 'error', 'warning'
            )
            ...
            closeButton: Optional[bool] = (
                None  # default False, whether to show the close button
            )
...
class PageSchema(AmisNode):
    ...
    url: Optional[str] = (
        None  # The page routing path, when the route hits the path, the current page is enabled. When the
    )
    ...
    schemaApi: Optional[API] = (
        None  # If you want to pull through the interface, please configure. The return path is
    )
    # json>data. Only one of schema and schemaApi can be selected.
    link: Optional[str] = (
        None  # If you want to configure an external link menu, you only need to configure link.
    )
    redirect: Optional[str] = (
        None  # Jump, when hitting the current page, jump to the target page.
    )
    rewrite: Optional[str] = (
        None  # Change to rendering pages of other paths, the page address will not be modified in this way.
    )
    isDefaultPage: Union[bool, str, None] = (
        None  # Useful when you need a custom 404 page, don't have multiple such pages,
    )
    # because only the first one will be useful.
    visible: Union[bool, str, None] = (
    ...
    tabsMode: Optional[TabsModeEnum] = (
        None  # Unofficial attribute. Display mode, the value can be line, card, radio, vertical,
    )
    ...
    def as_page_body(
        ...
        if self.children:
            ...
            if self.tabsMode is None:
                ...
                body = (
                    CollapseGroup.model_validate(
                        self.model_dump(exclude=exclude, exclude_defaults=True)
                    )
                    .update_from_kwargs(
                        body=[
                            CollapseGroup.CollapseItem.model_validate(
                                item.model_dump(exclude=exclude, exclude_defaults=True)
                            )
                            .update_from_kwargs(
                                header=item.label,
...
class App(Page):
    ...
    type: str = "app"
    api: Optional[API] = (
        None  # The page configuration interface, if you want to pull the page configuration remotely,
    )
    ...
    asideBefore: SerializeAsAny[Optional[Template]] = (
        None  # The front area on the page menu.
    )
    asideAfter: SerializeAsAny[Optional[Template]] = (
        None  # The front area under the page menu.
    )
    footer: SerializeAsAny[Optional[Template]] = None  # The page.
    pages: SerializeAsAny[Optional[List[Union[PageSchema, dict]]]] = (
...
class Custom(AmisNode):
    ...
    onMount: Optional[str] = (
        None  # "Function" # Function called after node initialization
    )
    onUpdate: Optional[str] = (
        None  # "Function" # The function called when the data is updated
    )
    onUnmount: Optional[str] = (
        None  # "Function" # The function called when the node is destroyed
    )
...
class Service(AmisNode):
    ...
    messages: Optional[dict] = (
        None  # Message prompt override, the default message reads the toast prompt text returned by the
    )
    ...
    stopAutoRefreshWhen: Optional[Expression] = (
        None  # Configure the condition to stop polling
    )
...
class Nav(AmisNode):
    ...
    class Link(AmisNode):
        ...
        activeOn: Optional[Expression] = (
            None  # whether to highlight the condition, leaving it blank will automatically
        )
        # analyze the link address
        defer: Optional[bool] = None  # mark whether it is a lazy add-in
        deferApi: Optional[API] = (
    ...
    deferApi: Optional[API] = (
        None  # The interface used to delay loading option details. It can be left unconfigured,
    )
    # and the public source interface cannot be configured.
    itemActions: SerializeAsAny[Optional[SchemaNode]] = (
        None  # More operations related configuration
    )
...
class AnchorNav(AmisNode):
    ...
    class Link(AmisNode):
        ...
        className: Optional[str] = (
            None  # "bg-white bl br bb wrapper-md" # Area member style
        )
    ...
    direction: Optional[str] = (
        None  # "vertical" # You can configure whether the navigation is displayed horizontally or
    )
...
class Validation(BaseAmisModel):
    ...
    isLength: Optional[int] = (
        None  # whether the length is exactly equal to the set value.
    )
...
class FormItem(AmisNode):
    ...
    class AutoFill(BaseAmisModel):
        showSuggestion: Optional[bool] = (
            None  # true refers to input, false automatically fills
        )
        api: Optional[API] = (
            None  # Automatically populate the interface/filter the CRUD request configuration with reference to entry
        )
        silent: Optional[bool] = (
            None  # Whether to display a data format error message. The default value is true
        )
        fillMappinng: SerializeAsAny[Optional[SchemaNode]] = (
        ...
        mode: Optional[str] = (
            None  # When showSuggestion is true, refer to the popOver mode: dialog, drawer, popOver
        )
        labelField: Optional[str] = (
            None  # When showSuggestion is true, set the popup dialog,drawer,popOver picker's labelField
        )
        position: Optional[str] = (
            None  # If showSuggestion is true, set the popOver location as shown in the input mode Popover
        )
        size: Optional[str] = (
            None  # If showSuggestion is true, set the value as shown in dialog mode
        )
        columns: SerializeAsAny[Optional[List["TableColumn"]]] = (
            None  # When showSuggestion is true, the data display column configuration
        )
        filter: SerializeAsAny[Optional[SchemaNode]] = (
    ...
    name: Optional[str] = (
        None  # Field name, specifying the key when the form item is submitted
    )
    label: Union[bool, Template, None] = None  # form item label template or false
    labelAlign: Optional[str] = (
        None  # "right" # Form item label alignment, default right alignment, only effective when mode is
    )
    ...
    submitOnChange: Optional[bool] = (
        None  # whether to submit the current form when the value of the form item changes.
    )
    disabled: Optional[bool] = None  # whether the current form item is disabled
    disabledOn: Optional[Expression] = (
    ...
    requiredOn: Optional[Expression] = (
        None  # Use an expression to configure whether the current form item is required.
    )
    validations: SerializeAsAny[Optional[Union[Validation, Expression]]] = (
    ...
    autoFill: Optional[AutoFill] = (
        None  # Data entry configuration, automatic filling or reference entry
    )
    static: Optional[bool] = (
        None  # 2.4.0 Whether the current form item is static display,
    )
    staticOn: Optional[Expression] = (
    ...
    staticLabelClassName: Optional[str] = (
        None  # 2.4.0 The class name of the Label for static display
    )
    staticInputClassName: Optional[str] = (
...
class Form(AmisNode):
    ...
    name: Optional[str] = (
        None  # After setting a name, it is convenient for other components to communicate with it
    )
    mode: Optional[DisplayModeEnum] = (
    ...
    submitText: Optional[Optional[str]] = (
        None  # "Submit" # Default submit button name, if it is set to empty, the default
    )
    # button can be removed.
    className: Optional[str] = None  # The class name of the outer Dom
    body: SerializeAsAny[Optional[List[Union[FormItem, SchemaNode]]]] = (
        None  # Form item collection
    )
    actions: SerializeAsAny[Optional[List["Action"]]] = (
        None  # Form submit button, the member is Action
    )
    actionsClassName: Optional[str] = None  # class name of actions
    messages: SerializeAsAny[Optional[Messages]] = (
    ...
    wrapWithPanel: Optional[bool] = (
        None  # whether to wrap the Form with panel, if set to false, actions will be invalid.
    )
    ...
    stopAutoRefreshWhen: Optional[str] = (
        None  # Configure the condition for stopping refresh by expression
    )
    initAsyncApi: Optional[API] = (
        None  # The api that Form uses to obtain initial data, which is different from initApi,
    )
    # will keep polling and request this interface until the returned finished attribute is true.
    initFetch: Optional[bool] = (
        None  # After initApi or initAsyncApi is set, the request will be sent by default, and if it is
    )
    ...
    initFinishedField: Optional[Optional[str]] = (
    ...
    initCheckInterval: Optional[int] = (
        None  # After setting initAsyncApi, the default pull interval
    )
    asyncApi: Optional[API] = (
        None  # After setting this property, after the form is submitted and sent to save the interface,
    )
    # it will continue to poll and request the interface, and it will not end until the returned finished property is
    # true.
    checkInterval: Optional[int] = (
        None  # The time interval for polling requests, the default is 3 seconds. Setting asyncApi
    )
    # is valid
    finishedField: Optional[Optional[str]] = (
    ...
    resetAfterSubmit: Optional[bool] = (
        None  # whether to reset the form after submitting
    )
    primaryField: Optional[str] = (
        None  # Set the primary key id. When set, it will only carry this data when checking whether
    )
    # the form is completed (asyncApi).
    target: Optional[str] = (
        None  # The default form submission itself will save the data by sending the api, but you can also
    )
    ...
    redirect: Optional[str] = (
        None  # After setting this attribute, after the Form is saved successfully, it will automatically
    )
    # jump to the specified page. Support relative addresses, and absolute addresses (relative to the group).
    reload: Optional[str] = (
        None  # Refresh the target object after the operation. Please fill in the name value set by the
    )
    ...
    canAccessSuperData: Optional[bool] = (
        None  # Specify whether the upper layer data can be automatically obtained and mapped
    )
    # to the form item
    persistData: Optional[str] = (
        None  # Specify a unique key to configure whether to enable local caching for the current form
    )
    clearPersistDataAfterSubmit: Optional[bool] = (
    ...
    promptPageLeave: Optional[bool] = (
        None  # The form has not been saved, whether to confirm with a pop-up box before leaving
    )
    # the page.
    columnCount: Optional[int] = None  # The form item is displayed as several columns
    debug: Optional[bool] = None
    inheritData: Optional[bool] = (
        None  # true # The default form is to create its own data field in the form of a data link,
    )
...
class InputSubForm(FormItem):
    ...
    labelField: Optional[str] = (
        None  # When this field exists in the value, the button name will be displayed using the value
    )
    # of this field.
...
class Button(FormItem):
    ...
    url: Optional[str] = (
        None  # Click the jump address, specify the behavior of this attribute button is consistent with the
    )
    # a link
    ...
    level: Optional[LevelEnum] = (
        None  # Set button style 'link'|'primary'|'enhance'|'secondary'|'info'|'success'|'warning
    )
    # '|'danger'|'light'| 'dark'|'default'
    tooltip: Union[str, dict, None] = None  # Bubble tip content TooltipObject
    tooltipPlacement: Optional[str] = (
        None  # Balloon positioner 'top'|'right'|'bottom'|'left'
    )
...
class InputFormula(FormItem):
    ...
    header: Optional[str] = (
        None  # Editor header title, if not set, the form item labelfield is used by default
    )
    evalMode: Optional[bool] = (
        None  # default True, Expression mode or template mode (False),
    )
    ...
    variableMode: Literal["tabs", "tree", "list"] = (
        "list"  # Can be configured as tabs or tree ,
    )
    # defaults to a list, which supports grouping.
    inputMode: Optional[Literal["button", "input-button", "input-group"]] = (
    ...
    borderMode: Optional[Literal["full", "half", "none"]] = (
        None  # Input box border mode
    )
    ...
    mixedMode: Optional[bool] = (
        None  # default False, if True it supports values in both text and formula formats
    )
...
class InputArray(FormItem):
    ...
    draggable: Optional[bool] = (
        None  # False # whether drag sorting is possible, it should be noted that when drag sorting is
    )
    # enabled, there will be an additional $id field
    draggableTip: Optional[str] = (
        None  # Draggable prompt text, the default is: "Order can be adjusted by dragging the [Swap]
    )
    # button in each row"
    ...
    scaffold: Optional[Any] = (
        None  # 新增成员时的默认值，一般根据items的数据类型指定需要的默认值
    )
...
class Radios(FormItem):
    ...
    selectFirst: Optional[bool] = (
        None  # False # whether to select the first one by default
    )
    autoFill: Optional[dict] = None  # autofill
...
class ChartRadios(Radios):
    ...
    showTooltipOnHighlight: Optional[bool] = (
...
class Checkboxes(FormItem):
    ...
    addControls: SerializeAsAny[Optional[List[FormItem]]] = (
        None  # Customize new form items
    )
    addApi: Optional[API] = None  # Configure the new option interface
    editable: Optional[bool] = None  # False # edit options
    editControls: SerializeAsAny[Optional[List[FormItem]]] = (
        None  # Customize edit form items
    )
...
class InputCity(FormItem):
    ...
    extractValue: Optional[bool] = (
        None  # True# whether to extract the value, if set to false, the value format will become an
    )
...
class InputColor(FormItem):
    ...
    presetColors: Optional[List[str]] = (
    ...
    allowCustomColor: Optional[bool] = (
        None  # True # When false, only colors can be selected, use presetColors to set the
    )
    # color selection range
    clearable: Optional[bool] = None  # "label" # whether to display the clear button
    resetValue: Optional[str] = (
...
class Combo(FormItem):
    ...
    type: str = "combo"
    formClassName: Optional[str] = (
        None  # The class name of a single group of form items
    )
    addButtonClassName: Optional[str] = None  # Add button CSS class name
    items: SerializeAsAny[Optional[List[FormItem]]] = (
        None  # Form items displayed in combination
    )
    ...
    delimiter: Optional[str] = (
        None  # "False" # What delimiter to use when flattening is on and joinValues is true.
    )
    addable: bool = False  # whether it can be added
    addButtonText: Optional[str] = None  # "Add" # Add button text
    removable: bool = False  # whether it can be removed
    deleteApi: Optional[API] = (
        None  # If configured, an api will be sent before deletion, and the deletion will be completed
    )
    # after the request is successful
    deleteConfirmText: Optional[str] = (
        None  # "Confirm to delete?" # It only takes effect when deleteApi is configured! Used
    )
    ...
    # enabled, there will be an additional $id field
    draggableTip: Optional[str] = (
        None  # "Order can be adjusted by dragging the [Exchange] button in each row" # Draggable
    )
    # prompt text
    ...
    conditions: Optional[dict] = (
        None  # The form of an array contains the rendering types of all conditions. The test in a
    )
    ...
    subFormHorizontal: Optional[dict] = (
        None  # The horizontal configuration of the sub-form item, which is the same as the
    )
...
class ConditionBuilder(FormItem):
    ...
    class Field(AmisNode):
        ...
        operators: Optional[List[str]] = (
            None  # If not so many, you can configure overrides.
        )
    ...
    class Datetime(Date):
        ...
        timeFormat: Optional[str] = (
            None  # The default "HH:mm" time format determines which input boxes are available.
        )
    ...
    class Select(Field):
        ...
        type: str = "select"
        options: Optional[OptionsNode] = (
            None  # options list, Array<{label: string, value: any}>
        )
        source: Optional[API] = None  # Dynamic options, please configure api.
        searchable: Optional[bool] = None  # whether it can be searched
        autoComplete: Optional[API] = (
            None  # Automatically prompt for completion, each time new content is entered,
        )
    ...
    fields: SerializeAsAny[Optional[List[Field]]] = (
...
class Editor(FormItem):
    ...
    language: Optional[str] = (
        None  # "javascript" # The language highlighted by the editor, which can be obtained through the
    )
    # ${xxx} variable
    ...
    allowFullscreen: Optional[bool] = (
        None  # False # whether to display the full screen mode switch
    )
    options: Optional[dict] = (
        None  # Other configurations of the monaco editor, such as whether to display line numbers, etc.,
    )
...
class Formula(AmisNode):
    ...
    type: str = "formula"
    name: Optional[str] = (
        None  # The formula result will be applied to the variable (name) specified here.
    )
    ...
    autoSet: Optional[bool] = (
        None  # Default True, Observe the formula result, if the calculation result changes,
    )
    # it will be automatically applied to the variable
    id: Optional[bool] = (
        None  # Default True, Define a name. When a button's target is specified, it will trigger a formula.
    )
...
class GridNav(AmisNode):
    ...
    class OptionsItem(AmisNode):
        ...
        link: Optional[str] = (
            None  # default '', Internal page path or external URL address, takes precedence over clickAction
        )
        blank: Optional[bool] = (
    ...
    square: Optional[bool] = (
        None  # default False, whether to fix list items to be square
    )
    center: Optional[bool] = (
        None  # default False, whether to center the content of the list item
    )
...
class CollapseGroup(AmisNode):
    ...
    activeKey: Union[str, int, List[Union[int, str, None]], None] = (
    ...
    body: SerializeAsAny[Optional[List[Union[CollapseItem, SchemaNode]]]] = (
        None  # group content
    )
...
class InputFile(FormItem):
    ...
    accept: Optional[str] = (
        None  # "text/plain" # Only plain text is supported by default. To support other types,
    )
    # please configure this property as the file suffix .xxx
    asBase64: Optional[bool] = (
        None  # False # Assign the file to the current component in the form of base64
    )
    asBlob: Optional[bool] = (
        None  # False # Assign the file to the current component in binary form
    )
    maxSize: Optional[int] = (
        None  # There is no limit by default, when set, the file size larger than this value will not be
    )
    # allowed to upload. unit is B
    maxLength: Optional[int] = (
        None  # There is no limit by default. When set, only the specified number of files can be
    )
    # uploaded at a time.
    ...
    autoUpload: Optional[bool] = (
        None  # True # No selection will automatically start uploading
    )
    hideUploadButton: Optional[bool] = None  # False # hide the upload button
    stateTextMap: Optional[dict] = (
        None  # Upload state text Default: {init: '', pending: 'Waiting to upload', uploading:
    )
    # 'Uploading', error: 'Upload error', uploaded: 'Uploaded',ready: ''}
    fileField: Optional[str] = (
        None  # "file" # You can ignore this attribute if you don't want to store it yourself.
    )
    nameField: Optional[str] = (
        None  # "name" # Which field is returned by the interface to identify the file name
    )
    valueField: Optional[str] = (
        None  # "value" # The value of the file is identified by that field.
    )
    urlField: Optional[str] = (
        None  # "url" # The field name of the file download address.
    )
    btnLabel: Optional[str] = None  # The text of the upload button
    downloadUrl: Union[bool, str, None] = (
    ...
    useChunk: Optional[bool] = (
        None  # The server where amis is located limits the file upload size to no more than 10M,
    )
    ...
    autoFill: Optional[Dict[str, str]] = (
...
class InputTable(FormItem):
    ...
    perPage: Optional[int] = (
        None  # Set how many pieces of data are displayed on one page. 10
    )
    ...
    needConfirm: Optional[bool] = (
        None  # True # whether to confirm the operation, it can be used to control the operation
    )
    # interaction of the control table
    canAccessSuperData: Optional[bool] = (
        None  # False # whether you can access the parent data, that is, the same level data
    )
    # in the form, usually need to be used with strictMode
    strictMode: Optional[bool] = (
        None  # True # For performance, the default value of other form items will not update the
    )
...
class InputGroup(FormItem):
    ...
    className: Optional[str] = None  # CSS class name
    body: SerializeAsAny[Optional[List[Union[FormItem, AmisNode]]]] = (
        None  # Form item collection
    )
...
class Group(InputGroup):
    ...
    type: str = "group"
    mode: Optional[DisplayModeEnum] = (
        None  # Display the default, the same as the mode in Form
    )
    gap: Optional[str] = None  # Gap between form items, optional: xs, sm, normal
    direction: Optional[str] = (
        None  # "horizontal" # Can be configured to display horizontally or vertically. The
    )
...
class InputImage(FormItem):
    ...
    class CropInfo(BaseAmisModel):
        aspectRatio: Optional[float] = (
            None  # Crop ratio. Floating point, the default is 1, which is 1:1. If you want to set
        )
        ...
        scalable: Optional[bool] = (
            None  # False # whether it can be scaled when cropping
        )
    ...
    class Limit(BaseAmisModel):
        ...
        aspectRatio: Optional[float] = (
            None  # Limit the aspect ratio of the image, the format is a floating-point number,
        )
    ...
    receiver: Optional[API] = None  # Upload file interface
    accept: Optional[str] = (
        None  # ".jpeg,.jpg,.png,.gif" # Supported picture types and formats, please configure this
    )
    ...
    cropQuality: Optional[int] = (
        None  # 1 # The quality of the crop file format, for jpeg/webp, between 0 and 1
    )
    limit: Optional[Limit] = (
        None  # Limit the size of the image, beyond which it will not be allowed to upload.
    )
    frameImage: Optional[str] = None  # Default placeholder image address
    fixedSize: Optional[bool] = (
        None  # whether to enable fixed size, if enabled, set fixedSizeClassName at the same time
    )
    fixedSizeClassName: Optional[str] = (
    ...
    uploadBtnText: SerializeAsAny[Optional[SchemaNode]] = (
        None  # 上传按钮文案。支持tpl、schema形式配置。
    )
...
class Picker(FormItem):
    ...
    extractValue: Optional[bool] = None  # False # extract value
    autoFill: Optional[dict] = None  # autofill
    modalMode: Optional[Literal["dialog", "drawer"]] = (
        None  # "dialog" # Set dialog or drawer to configure the popup mode.
    )
    pickerSchema: SerializeAsAny[Optional[Union[SchemaNode, "CRUD"]]] = (
...
class InputText(FormItem):
    ...
    addOn: SerializeAsAny[Optional[SchemaNode]] = (
        None  # Input box add-ons, such as with a prompt text, or with a submit button.
    )
    trimContents: Optional[bool] = (
        None  # whether to remove leading and trailing blank text.
    )
    creatable: Optional[bool] = (
        None  # whether it can be created, the default is yes, unless it is set to false, only the
    )
...
class InputRating(FormItem):
    ...
    allowClear: Optional[bool] = (
        None  # default True, allow clearing after another click
    )
    ...
    texts: Optional[dict] = (
        None  # default -, The tooltip text when the star is selected.
    )
...
class InputRange(FormItem):
    ...
    marks: Union[str, dict, None] = (
        None  # Tick Marks, Support Custom Styles, Set Percentages
    )
    # { [number | string]: ReactNode }or{ [number | string]: { style: CSSProperties, label: ReactNode } }
    tooltipVisible: Optional[bool] = (
        None  # default False, whether to show slider labels
    )
    tooltipPlacement: Optional[PlacementEnum] = (
    ...
    clearable: Optional[bool] = (
        None  # default False, whether the precondition can be cleared : showInputValid when enabled
    )
...
class Timeline(AmisNode):
    ...
    class TimelineItem(AmisNode):
        ...
        color: Union[str, LevelEnum, None] = (
            None  # default #DADBDD, Timeline node color
        )
        icon: Optional[str] = (
            None  # Icon name, support fontawesome v4 or use url (priority is higher than color)
        )

    type: str = "timeline"
    items: Optional[List[TimelineItem]] = None  # default [], Nodes
    source: Optional[API] = (
        None  # Data source, you can obtain current variables through data mapping, or configure API objects
    )
    mode: Literal["left", "right", "alternate"] = (
...
class Steps(AmisNode):
    ...
    labelPlacement: Literal["vertical", "horizontal"] = (
...
class TooltipWrapper(AmisNode):
    ...
    style: Union[str, dict, None] = (
        None  # Custom style (inline style), highest priority
    )
    tooltipStyle: Union[str, dict, None] = None  # floating layer custom style
    body: SerializeAsAny[Optional[SchemaNode]] = None  # Content container
    wrapperComponent: Optional[str] = None  # "div" | "span"
    inline: Optional[bool] = (
        None  # default False, whether the content area is displayed inline
    )
    rootClose: Optional[bool] = (
        None  # default True, whether to click the non-content area to close the prompt
    )
    mouseEnterDelay: Optional[int] = (
        None  # default 0, Floating layer delay display time, in ms
    )
    mouseLeaveDelay: Optional[int] = (
        None  # default 300, Floating layer delay hiding time, in ms
    )
...
class InputTag(FormItem):
    ...
    optionsTip: Optional[List[Union[str, dict]]] = (
    ...
    clearable: Optional[bool] = (
        None  # default False, whether to show a delete icon on the right when there is a value.
    )
    resetValue: Optional[str] = (
        None  # default "", Set the value given by this configuration item after deletion.
    )
    ...
    overflowTagPopover: Optional[TooltipWrapper] = (
    ...
    enableBatchAdd: Optional[bool] = (
        None  # default 	False, whether to enable batch add mode
    )
    separator: Optional[str] = (
        None  # default "-", After batch adding is enabled, enter the delimiter of multiple labels,
    )
...
class Select(FormItem):
    ...
    checkAllBySearch: Optional[bool] = (
        None  # False # When there is a search, only all items hit by the search are selected
    )
    defaultCheckAll: Optional[bool] = None  # False # whether to check all by default
    creatable: Optional[bool] = None  # False # New option
    ...
    selectMode: Optional[str] = (
        None  # Optional: group, table, tree, chained, associated. They are: list form, table form,
    )
    ...
    searchResultMode: Optional[str] = (
        None  # If the value of selectMode is not set, it can be configured separately. Refer to
    )
    ...
    leftOptions: Optional[List[dict]] = (
        None  # Used to configure the left option set when the display form is associated.
    )
    leftMode: Optional[str] = (
        None  # When the display form is associated, it is used to configure the left selection form,
    )
    # support list or tree. Default is list.
    rightMode: Optional[str] = (
        None  # When the display form is associated, it is used to configure the right selection form,
    )
...
class NestedSelect(Select):
    ...
    cascade: Optional[bool] = (
        None  # False # When set to true, child nodes are not automatically selected when the parent node
    )
    # is selected.
    withChildren: Optional[bool] = (
        None  # False # When set to true, when the parent node is selected, the value of the child
    )
    # node will be included in the value, otherwise only the value of the parent node will be retained.
    onlyChildren: Optional[bool] = (
        None  # False # For multiple selections, whether to add only its child nodes to the value
    )
    # when the parent node is selected.
    searchPromptText: Optional[str] = (
    ...
    hideNodePathLabel: Optional[bool] = (
        None  # False # whether to hide the path label information of the selected node in the
    )
    # selection box
    onlyLeaf: Optional[bool] = (
        None  # False # Only leaf nodes are allowed to be selected
    )
...
class Breadcrumb(AmisNode):
    ...
    items: SerializeAsAny[Optional[List[BreadcrumbItem]]] = (
        None  # list of breadcrumb icons
    )
...
class Card(AmisNode):
    ...
    class Header(AmisNode):
        ...
        avatarClassName: Optional[str] = (
            None  # default "pull-left thumb avatar b-3x m-r", Image includes layer class name
        )
        imageClassName: Optional[str] = None  # Image class name
        avatarText: Optional[Template] = (
            None  # If no picture is configured, the text will be displayed at the picture
        )
        ...
        highlight: Optional[bool] = (
            None  # default False, whether to show the active style
        )
    ...
    actions: SerializeAsAny[Optional[List[Action]]] = (
        None  # Configure button collection
    )
    ...
    checkable: Optional[bool] = (
        None  # default True, selection button is disabled or not
    )
    selected: Optional[bool] = (
        None  # default False, selection button is selected or not
    )
    ...
    useCardLabel: Optional[bool] = (
        None  # default True, Whether the form item label in the card content area uses the
    )
...
class ListDisplay(AmisNode):
    ...
    listItem: SerializeAsAny[Optional[ListItem]] = (
        None  # configured list object for repeat
    )
...
class InputMonth(FormItem):
    ...
    format: Optional[str] = (
        None  # "X" # Month selector value format, please refer to moment for more format types
    )
    inputFormat: Optional[str] = (
        None  # "YYYY-MM" # The display format of the month selector, that is, the timestamp format.
    )
...
class InputTime(FormItem):
    ...
    value: Optional[str] = None  # default value
    timeFormat: Optional[str] = (
        None  # "HH:mm" # Time selector value format, please refer to moment for more format types
    )
    format: Optional[str] = (
        None  # "X" # Time selector value format, please refer to moment for more format types
    )
    inputFormat: Optional[str] = (
        None  # "HH:mm" # Time selector display format, that is, timestamp format, please refer to
    )
...
class InputDatetime(FormItem):
    ...
    value: Optional[str] = None  # default value
    format: Optional[str] = (
        None  # "X" # Date time picker value format, please refer to the documentation for more format types
    )
    inputFormat: Optional[str] = (
        None  # "YYYY-MM-DD HH:mm:ss" # Date time picker display format, namely timestamp format,
    )
    # please refer to the documentation for more format types
    placeholder: Optional[str] = (
        None  # "Please select a date and time" # placeholder text
    )
...
class InputDate(FormItem):
    ...
    value: Optional[str] = None  # default value
    format: Optional[str] = (
        None  # "X" # Date picker value format, please refer to the documentation for more format types
    )
    inputFormat: Optional[str] = (
        None  # "YYYY-DD-MM" # Date picker display format, that is, timestamp format, please refer to
    )
    ...
    timeConstraints: Optional[dict] = None  # True # Please refer to: react-datetime
    closeOnSelect: Optional[bool] = (
        None  # False # whether to close the selection box immediately after clicking the date
    )
    ...
    scheduleClassNames: Optional[List[str]] = (
    ...
    scheduleAction: SerializeAsAny[Optional[SchemaNode]] = (
        None  # Custom schedule display
    )
...
class InputQuarterRange(FormItem):
    ...
    minDate: Optional[str] = (
        None  # Limit the minimum date and time, the usage is the same as the limit range
    )
    maxDate: Optional[str] = (
        None  # Limit the maximum date and time, the usage is the same as the limit range
    )
...
class Calendar(FormItem):
    ...
    todayActiveStyle: Union[str, dict, None] = (
        None  # Custom styles when activated today
    )
...
class InputKV(FormItem):
    ...
    draggable: Optional[bool] = (
        None  # Default True, Whether to drag and drop to sort is allowed
    )
...
class InputKVS(FormItem):
    ...
    type: str = "input-kvs"
    addButtonText: Optional[str] = (
        None  # default 'new field', butto text of the add button
    )
    draggable: Optional[bool] = (
        None  # Default True, Whether to drag and drop to sort is allowed
    )
...
class Transfer(FormItem):
    ...
    selectMode: Optional[str] = (
        None  # "list" # Optional: list, table, tree, chained, associated. They are: list form,
    )
    ...
    # optional: list, table, tree, chained.
    menuTpl: SerializeAsAny[Optional[SchemaNode]] = (
        None  # Used to customize option display
    )
    valueTpl: SerializeAsAny[Optional[SchemaNode]] = (
        None  # Used to customize the display of the value
    )
...
class InputTree(FormItem):
    ...
    deleteApi: Optional[API] = None  # Configure delete option interface
    searchable: Optional[bool] = (
        None  # False # whether it is searchable, it only takes effect when type is tree-select
    )
    hideRoot: Optional[bool] = (
        None  # True # Set to false if you want to show a top-level node
    )
    rootLabel: Optional[bool] = (
    ...
    showRadio: Optional[bool] = (
        None  # False # whether to show radio buttons, multiple is false is valid.
    )
    initiallyOpen: Optional[bool] = (
        None  # True # Set whether to expand all levels by default.
    )
    unfoldedLevel: Optional[int] = (
        None  # 0 # Set the default unfolded level, which only takes effect when initiallyOpen is
    )
    # not true.
    cascade: Optional[bool] = (
        None  # False # Do not automatically select child nodes when parent node is selected.
    )
    withChildren: Optional[bool] = (
        None  # False # When the parent node is selected, the value will contain the value of the
    )
    ...
    # when the parent node is selected.
    rootCreatable: Optional[bool] = (
        None  # False # whether top-level nodes can be created
    )
    rootCreateTip: Optional[str] = (
    ...
    pathSeparator: Optional[str] = (
        None  # "/" # The separator of the node path, it takes effect when enableNodePath is true
    )
    deferApi: Optional[API] = (
        None  # For lazy loading options, please configure defer to true, and then configure deferApi to
    )
...
class Image(AmisNode):
    ...
    thumbMode: Optional[str] = (
        None  # "contain" # preview mode, optional: 'w-full','h-full','contain','cover'
    )
    thumbRatio: Optional[str] = (
        None  # "1:1" # Preview ratio, optional: '1:1','4:3','16:9'
    )
    imageMode: Optional[str] = (
        None  # "thumb" Image display mode, optional: 'thumb', 'original' ie: thumbnail mode or original
    )
    # image mode
...
class Images(AmisNode):
    ...
    source: Optional[str] = None  # data source
    delimiter: Optional[str] = (
        None  # "," # Delimiter, when value is a string, use this value to separate and split
    )
    src: Optional[str] = (
        None  # Preview image address, support data mapping to obtain image variables in the object
    )
    originalSrc: Optional[str] = (
        None  # Original image address, support data mapping to obtain image variables in the object
    )
    enlargeAble: Optional[bool] = None  # Support zoom in preview
    thumbMode: Optional[str] = (
        None  # "contain" # preview mode, optional: 'w-full','h-full','contain','cover'
...
class Carousel(AmisNode):
    ...
    controlsTheme: Optional[str] = (
        None  # "light" # Left and right arrows, bottom dot index color, default light, and dark mode
    )
    animation: Optional[str] = (
        None  # "fade" # Switch animation effect, default fade, and slide mode
    )
    thumbMode: Optional[str] = (
        None  # "cover"|"contain" # The default zoom mode of the picture
    )
...
class CRUD(AmisNode):
    ...
    loadDataOnce: Optional[bool] = (
        None  # whether to load all data at once (front-end paging)
    )
    loadDataOnceFetchOnFilter: Optional[bool] = (
        None  # True # When loadDataOnce is turned on, whether to re-request the api
    )
    # when filtering
    source: Optional[str] = (
        None  # The data mapping interface returns the value of a field. If it is not set, the ${items} or
    )
    # ${rows} returned by the interface will be used by default. It can also be set to the content of the upper data
    # source.
    filter: SerializeAsAny[Optional[Union[SchemaNode, Form]]] = (
        None  # Set the filter, when the form is submitted, it will bring the data to
    )
    # the current mode refresh list.
    filterTogglable: Optional[bool] = (
        None  # False # whether the filter can be displayed or hidden
    )
    filterDefaultVisible: Optional[bool] = (
        None  # True # Set whether the filter is visible by default.
    )
    initFetch: Optional[bool] = (
        None  # True # whether to pull data during initialization, only for the case with filter,
    )
    ...
    stopAutoRefreshWhenModalIsOpen: Optional[bool] = (
        None  # Turn off auto refresh when there is a popup, close the popup and
    )
    # restore
    syncLocation: Optional[bool] = (
        None  # False # whether to synchronize the parameters of the filter conditions to the
    )
    ...
    quickSaveItemApi: Optional[API] = (
        None  # API to use when quick edit is configured to save in time.
    )
    bulkActions: SerializeAsAny[Optional[List[Action]]] = (
    ...
    defaultParams: Optional[dict] = (
        None  # Set the default filter default parameters, which will be sent to the backend
    )
    # together when querying
    pageField: Optional[str] = None  # Set the pagination page number field name. "page"
    perPageField: Optional[str] = (
        None  # "perPage" # Set the field name of how many pieces of data are displayed on one page.
    )
    # Note: Best used with defaultParams, see example below.
    perPageAvailable: Optional[List[int]] = (
        None  # [5, 10, 20, 50, 100] # Set how many data drop-down boxes can be displayed
    )
    # on one page.
    orderField: Optional[str] = (
        None  # Set the field name used to determine the position. After setting, the new order will be
    )
    # assigned to this field.
    hideQuickSaveBtn: Optional[bool] = None  # Hide the top quick save prompt
    autoJumpToTopOnPagerChange: Optional[bool] = (
        None  # whether to automatically jump to the top when splitting pages.
    )
    syncResponse2Query: Optional[bool] = (
    ...
    autoGenerateFilter: Optional[bool] = (
        None  # whether to open the query area, after it is enabled, the query condition form
    )
    # will be automatically generated according to the searchable attribute value of the column element
    itemAction: Optional[Action] = (
        None  # Implement custom actions after clicking a row, support all configurations in action,
    )
    ...
    resetPageAfterAjaxItemAction: Optional[bool] = (
        None  # False  # 单条数据 ajax 操作后是否重置页码为第一页
    )
...
class TableColumn(AmisNode):
    ...
    searchable: SerializeAsAny[Optional[Union[bool, SchemaNode]]] = (
    ...
    breakpoint: Optional[str] = (
        None  # *,ls. When there are too many columns, the content cannot be displayed completely,
    )
    ...
    toggled: Optional[bool] = (
        None  # whether to expand by default, in the column configuration, you can configure toggled to
    )
    # false to not display this column by default
    backgroundScale: Optional[int] = (
...
class Table(AmisNode):
    ...
    columnsTogglable: Union[bool, str, None] = (
    ...
    tableClassName: Optional[str] = (
        None  # "table-db table-striped" # table CSS class name
    )
    headerClassName: Optional[str] = (
        None  # "Action.md-table-header" # Top outer CSS class name
    )
    footerClassName: Optional[str] = (
        None  # "Action.md-table-footer" # Bottom outer CSS class name
    )
    toolbarClassName: Optional[str] = (
        None  # "Action.md-table-toolbar" # Toolbar CSS class name
    )
    columns: SerializeAsAny[Optional[List[Union[TableColumn, SchemaNode]]]] = (
        None  # Used to set column information
    )
    combineNum: Optional[int] = None  # Automatically combine cells
    itemActions: SerializeAsAny[Optional[List[Action]]] = (
        None  # Floating row action button group
    )
    itemCheckableOn: Optional[Expression] = (
        None  # Configure the condition for whether the current row can be checked, use an
    )
    # expression
    itemDraggableOn: Optional[Expression] = (
        None  # To configure whether the current row can be dragged or not, use an expression
    )
    checkOnItemClick: Optional[bool] = (
    ...
    rowClassNameExpr: Optional[Template] = (
        None  # Add CSS class name to row via template
    )
...
class Chart(AmisNode):
    ...
    source: Optional[dict] = (
        None  # Get the variable value in the data chain as configuration through data mapping
    )
    initFetch: Optional[bool] = (
...
class Code(AmisNode):
    ...
    language: Optional[str] = (
        None  # The highlighted language used, the default is plaintext
    )
...
class Json(AmisNode):
    ...
    jsonTheme: Optional[str] = (
        None  # "twilight" # Theme, optional twilight and eighties
    )
...
class Log(AmisNode):
    ...
    type: str = "log"
    source: Optional[API] = (
        None  # Support variables, which can be initially set to empty, so that it will not be loaded
    )
    ...
    encoding: Optional[str] = (
        None  # "utf-8" # The character encoding of the returned content
    )
...
class Property(AmisNode):
    ...
    mode: Optional[str] = (
        None  # 'table' # Display mode, currently only 'table' and 'simple'
    )
    separator: Optional[str] = (
...
class Progress(AmisNode):
    ...
    showThresholdText: Optional[bool] = (
    ...
    gapDegree: Optional[int] = (
        None  # default 75, angle of the missing corner of the instrument panel, the value can be 0 ~ 295
    )
    gapPosition: Optional[str] = (
        None  # default "bottom", Dashboard progress bar notch position, optional top bottom left right
    )


class PaginationWrapper(AmisNode):
    type: str = "pagination-wrapper"
    showPageInput: Optional[bool] = (
        None  # default False, whether to display the quick jump input box
    )
    maxButtons: Optional[int] = (
        None  # default 5, Maximum number of pagination buttons to display
    )
    inputName: Optional[str] = None  # default 'items', input field name
    outputName: Optional[str] = None  # default 'items', output field name
    perPage: Optional[int] = (
        None  # default 10, Display multiple pieces of data per page
    )
    position: Literal["top", "none", "bottom"] = (
...
class Video(AmisNode):
    ...
    isLive: Optional[bool] = (
        None  # False # whether it is a live broadcast, it needs to be added when the video is live,
    )
...
class Alert(AmisNode):
    ...
    className: Optional[str] = None  # The class name of the outer Dom
    level: Optional[str] = (
        None  # "info" # Level, can be: info, success, warning or danger
    )
    body: SerializeAsAny[Optional[SchemaNode]] = None  # Display content
...
class Dialog(AmisNode):
    ...
    body: SerializeAsAny[Optional[SchemaNode]] = (
        None  # Add content to the Dialog content area
    )
    size: Union[str, SizeEnum, None] = (
    ...
    closeOnEsc: Optional[bool] = (
        None  # False # whether to support pressing Esc to close Dialog
    )
    showCloseButton: Optional[bool] = (
        None  # True # whether to show the close button in the upper right corner
    )
    showErrorMsg: Optional[bool] = (
        None  # True # whether to display the error message in the lower left corner of the popup
    )
    disabled: Optional[bool] = (
        None  # False # If this property is set, the Dialog is read-only and has no submit operation.
    )
    actions: SerializeAsAny[Optional[List[Action]]] = (
    ...
    # and [Cancel]"
    data: Optional[dict] = (
        None  # Support data mapping, if not set, it will inherit the data in the context of the trigger
    )
    # button by default.
...
class Drawer(AmisNode):
    ...
    title: SerializeAsAny[Optional[SchemaNode]] = None  # Popup layer title
    body: SerializeAsAny[Optional[SchemaNode]] = (
        None  # Add content to the Drawer content area
    )
    size: Union[str, SizeEnum, None] = (
        None  # Specify Drawer size, support: xs, sm, md, lg
    )
    ...
    closeOnEsc: Optional[bool] = (
        None  # False # whether to support pressing Esc to close Drawer
    )
    closeOnOutside: Optional[bool] = (
        None  # False # whether to close the Drawer when clicking outside the content area
    )
    overlay: Optional[bool] = None  # True # whether to display the overlay
    resizable: Optional[bool] = (
        None  # False # whether the size of the Drawer can be changed by dragging and dropping
    )
    actions: SerializeAsAny[Optional[List[Action]]] = (
    ...
    showCloseButton: bool = (
        True  # 是否展示关闭按钮，当值为 false 时，默认开启 closeOnOutside
    )
...
class Tasks(AmisNode):
    ...
    class Item(AmisNode):
        ...
        status: Optional[str] = (
            None  # Task status: 0: Initial status, inoperable. 1: Ready, operational state. 2: In
        )
    ...
    reSubmitApi: Optional[API] = (
        None  # If the task fails and can be retried, this API will be used when submitting
    )
    interval: Optional[int] = (
        None  # 3000 # When there is a task in progress, it will be checked again at regular intervals,
    )
    ...
    statusTextMap: Optional[List[str]] = (
...
class Wizard(AmisNode):
    ...
    class Step(AmisNode):
        ...
        mode: Optional[str] = (
            None  # Display the default, the same as the mode in Form, choose: normal, horizontal or inline.
        )
        horizontal: Optional[Horizontal] = (
            None  # When in horizontal mode, it is used to control the ratio of left and right
        )
        api: Optional[API] = (
            None  # The current step saves the interface, which can be left unconfigured.
        )
        initApi: Optional[API] = None  # The current step data initialization interface.
        initFetch: Optional[bool] = (
            None  # whether the current step data initialization interface is initially fetched.
        )
        initFetchOn: Optional[Expression] = (
            None  # whether the current step data initialization interface is initially fetched
        )
        # is determined by an expression.
        body: SerializeAsAny[Optional[List[FormItem]]] = (
            None  # The form item collection of the current step, please refer to FormItem.
        )

    type: str = "wizard"  # Specify as Wizard component
    mode: Optional[str] = (
        None  # "horizontal" # Display mode, choose: horizontal or vertical
    )
    ...
    actionNextSaveLabel: Optional[str] = (
        None  # "Save and Next" # Save and Next button text
    )
    actionFinishLabel: Optional[str] = None  # "Finish" # Finish button text
    className: Optional[str] = None  # Outer CSS class name
    actionClassName: Optional[str] = (
        None  # "btn-sm btn-default" # Button CSS class name
    )
    reload: Optional[str] = (
        None  # Refresh the target object after the operation. Please fill in the name value set by the
    )
    ...
    target: Optional[str] = (
        None  # "False" # You can submit data to other components instead of saving it yourself. Please
    )
    ...
    startStep: Optional[int] = (
        None  # "1" # Start default value, starting from the first step. Templates can be supported,
    )
...
class FieldSet(FormItem):
    ...
    type: str = "fieldset"
    className: Optional[str] = None  # CSS class name
    headingClassName: Optional[str] = None  # Heading CSS class name
    bodyClassName: Optional[str] = None  # Body CSS class name
    title: Optional[Optional[str]] = None  # Fieldset title
    body: SerializeAsAny[Optional[List[Union[FormItem, AmisNode]]]] = (
        None  # Fieldset item collection
    )
    mode: Optional[str] = (
        None  # Display the default, the same as the mode in Form, choose: normal, horizontal or inline.
    )
    collapsable: Optional[bool] = None  # Whether the fieldset is collapsable.
    collapsed: Optional[bool] = None  # Whether the fieldset is collapsed.
    collapseTitle: SerializeAsAny[Optional[SchemaNode]] = None  # Collapse title.
